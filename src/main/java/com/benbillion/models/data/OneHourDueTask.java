...
@Setter
@Getter
@Table(name = "onehourdue")
public class OneHourDueTask {
    ...
    public OneHourDueTask(Long id, String title, String body, Status status, Date timeOfExecution, List<Comment> comments, String sendMeReminderMail) {
        this.title = title;
        this.body = body;
        this.status = status;
